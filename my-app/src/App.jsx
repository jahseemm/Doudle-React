    ...
    <>
      ...
      <div className="top-left" style={{top:'0', left:'0'}}>
        <div className="flex-row-panel" style={{ gap: '60px' }}>
          {/* Left Panel: Welcome */}
          <div className="panel" style={{ position: 'relative', backgroundColor: 'transparent', left: '0'}}>
            <div className="normal-text">
              ...
              <p style={{ color: 'aliceblue', lineHeight: '1.5', fontWeight: 'lighter' }}>
          ...
          {/* Right Panel: Sign-In */}
          <div className="panel" style={{ position: 'relative', backgroundColor: 'transparent' }}>
            <h1 className="center-text" style={{ marginTop: '10px', color: 'aliceblue', fontSize: '40px' }}>
              Sign-In
            </h1>

            <form id="login-form" style={{ marginTop: '30px', display: 'flex', flexDirection: 'column', gap: '15px' }}>
            ...
            <p style={{ color: 'aliceblue', fontWeight: 'lighter', fontSize: '14px' }}>
              Lost your password?{' '}
